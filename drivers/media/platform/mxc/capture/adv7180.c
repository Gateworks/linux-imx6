 ...
 *  @return		None.
 */
static void adv7180_hard_reset(bool cvbs, int id)
{
	dev_dbg(&adv7180_data.sen.i2c_client->dev,
	...
	/* Register writes dependent on chip id */
	switch (id) {
		case ID_ADV7180:
			 ...
			 const struct i2c_device_id *id)
{
	...
	adv7180_hard_reset(cvbs, (int) id->driver_data);
